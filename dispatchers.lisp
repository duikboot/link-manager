...
(push (create-static-file-dispatcher-and-handler "/images/logo.png" "images/logo.png")
      *dispatch-table*)
(push (create-static-file-dispatcher-and-handler "/style.css" "style/style.css") *dispatch-table*)
(push (create-static-file-dispatcher-and-handler "/jquery-ui.min.css" "style/jquery-ui.min.css")
      *dispatch-table*)
(push (create-static-file-dispatcher-and-handler "/bootstrap.css" "bootstrap/css/bootstrap.css")
      *dispatch-table*)
(push (create-static-file-dispatcher-and-handler "/bootstrap-js.js" "bootstrap/js/bootstrap.js")
      *dispatch-table*)
(push (create-static-file-dispatcher-and-handler "/jquery.js" "bootstrap/js/jquery-2.2.4-min.js")
      *dispatch-table*)
(push (create-static-file-dispatcher-and-handler "/jquery-ui.min.js" "bootstrap/js/jquery-ui.min.js")
      *dispatch-table*)
...
;;font awesome fonts
(push (create-static-file-dispatcher-and-handler "/font-awesome.css" "font-awesome-4.6.3/css/font-awesome.css")
      *dispatch-table*)
(push (create-static-file-dispatcher-and-handler
