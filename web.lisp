  ...
  (with-html-output
    ...
    (:footer :class "footer-distributed"
             (:div :class "footer-right"
                   (:a :href "https://twitter.com/u_boot"
  ...
  (standard-page
    ...
    (:div :style "margin: 0 auto; width: 90%"
          (:form :method "post" :class "form-horizontal" :action "/bookmarks/save"
                 ...
                 (:div :class "form-group"
                       (:label :for "bf_title"
                               :class "col-sm-2 control-label" "Title")
                       (:div :class "col-sm-10"
                             (:input
                               :type "text" :id "bf_title"
                 ...
                 (:div :class "form-group"
                       (:label
                         :for "bf_link"
                         :class "col-sm-2 control-label" "Link")
                       (:div :class "col-sm-10"
                             (:input
                               :type "url"
                               :id "bf_link"
                 ...
                 (:div :class "form-group"
                       (:label
                         :for "bf_sum"
                         :class "col-sm-2 control-label" "Summary")
                       (:div :class "col-sm-10"
